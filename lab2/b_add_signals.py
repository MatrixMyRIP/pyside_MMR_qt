...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.comboBox.currentTextChanged.connect(self.oncomboBox) # TODO подключить слот для вывода текста в plainTextEditLog при изменении выбранного элемента в comboBox
    ...
    def oncomboBox(self, text):
        self.plainTextEditLog.setPlainText(str(text))

    def onspinBox(self, value):
        self.plainTextEditLog.setPlainText(str(value))

    def ondateTimeEdit(self, dateTime):
