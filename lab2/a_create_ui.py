...
class Window(QtWidgets.QWidget):
    ...
    def initUi(self) -> None:
        ...
        labelLogin = QtWidgets.QLabel()  # TODO Создайте виджет QLabel с текстом "Логин"
        labelLogin.setText("Логин")
        labelRegistration = QtWidgets.QLabel()  # TODO Создайте виджет QLabel с текстом "Регистрация"
        labelRegistration.setText("Регистрация")
